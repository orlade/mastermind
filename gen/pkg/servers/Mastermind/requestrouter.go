...
// Router interface for Mastermind
type Router interface {
	Route(router *chi.Mux)
}

// ServiceRouter for Mastermind API
...
// NewServiceRouter creates a new service router for Mastermind
...
func (s *ServiceRouter) WireRoutes(ctx context.Context, r chi.Router) {
	r.Route(core.SelectBasePath(s.basePathFromSpec, s.gc.BasePath()), func(r chi.Router) {
		...
		r.Get("/repos/{owner}/{repo}/issues", s.svcHandler.GetReposIssuesListHandler)
	})
}
